$(function () {
  ...
  function onHashChange() {
    var href = window.location.hash || '#home';
    if (href == '#blog') {
      $('.tab-page').hide();
      $(href + '-page').show();
      $('.main-nav').removeClass('nav-spy');
      $('.main-nav li.active').removeClass('active');
      $('.main-nav [href=' + href + ']').parent('li').addClass('active');
    } else {
      $('.tab-page').hide();
      $('#main-page').show();
      $('.main-nav').addClass('nav-spy');
      $('.main-nav li.active').removeClass('active');
      $('.main-nav [href=' + href + ']').parent('li').addClass('active');
      var offset = $(href + '-anchor').offset();
      if (offset) {
